...
Also, I have begun building a second application with the same database and Java Spring on the back end, as I am learning that for my next job. The plan is to build a RESTful API with Java Spring that exposes this database to an Angular front end. The Angular front end will begin development after the back end is completed. The source files can be found in the java_delivery directory above.  As I implement more of the CRUD functionality in the API, I will be pushing to this directory and adding screenshots to the end of this readme.
